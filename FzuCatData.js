...
function FZUCAT(){
    ...
    for(var j=0;j<15;j++)
    {
        console.log(FzuCat_Name[j]);
        console.log(FzuCat_Gender[j]);
        console.log(FzuCat_Character[j]);
        console.log(FzuCat_Variety[j]);
        console.log(FzuCat_Bodytype[j]);
        console.log(FzuCat_Hauntedplace[j]);
        console.log(FzuCat_People[j]);
        console.log(FzuCat_Condition[j]);
       // console.log(FzuCat_Name.length);
    }
}
